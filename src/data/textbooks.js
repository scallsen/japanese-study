...
export const TEXTBOOKS = [
  ...
  {
    id: 'nsm-n3',
    title: 'So-Matome N3 — course I-3',
    subtitle: 'Course notes · N3',
    publisher: 'Personal',
    description: 'A class\'s own chunking of the N3 kanji book, with its own example sentences and review markers.',
    purchase: [],
    icon: `${ICONS}/nihongo-so-matome-kanji-n3.svg`,
  ...
  {
    id: 'nsm-n3-i4',
    title: 'So-Matome N3 — course I-4',
    subtitle: 'Course notes · N3',
    publisher: 'Personal',
    description: 'The second course volume of the same N3 material.',
    purchase: [],
    icon: `${ICONS}/nihongo-so-matome-kanji-n3.svg`,
  ...
  {
    id: 'nsm-n3-i5',
    title: 'So-Matome N3 — course I-5',
    subtitle: 'Course notes · N3',
    publisher: 'Personal',
    description: 'The third course volume of the same N3 material.',
    purchase: [],
    icon: `${ICONS}/nihongo-so-matome-kanji-n3.svg`,
  ...
  {
    id: 'nsm-n2-a1',
    title: 'So-Matome N2 — course A-1',
    subtitle: 'Course notes · N2',
    publisher: 'Personal',
    description: 'A class\'s own chunking of the N2 material, with its own example sentences.',
    purchase: [],
  ...
  {
    id: 'nsm-n2-a2',
    title: 'So-Matome N2 — course A-2',
    subtitle: 'Course notes · N2',
    publisher: 'Personal',
    description: 'The second course volume of the same N2 material.',
    purchase: [],
    icon: `${ICONS}/nihongo-so-matome-kanji-n2.svg`,
