...
import { FONT, TRACKING, TEXT, TEXT_MUTED, SUBHEADING_STYLE, FS_BASE, FS_BADGE, FS_LIST_TITLE } from '../../data/theme.js'
  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{ fontSize: FS_BASE, color: TEXT_MUTED, fontFamily: FONT, letterSpacing: TRACKING, flexShrink: 0, cursor: 'pointer' }}
      >
        Remove
      </span>
    </div>
